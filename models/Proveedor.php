...
class Proveedor extends MainModel{
    ...
    protected static $columnaDB = ['id','nombre','apellido','correo','contraseña','imagen','telefono','id_estado_prov','id_tipo_prov'];
    ...
    public function __construct($args = [])
    {
        ...
        $this->id_estado_prov = $args['id_estado_prov'] ?? '';
        $this->id_tipo_prov = $args['id_tipo_prov'] ?? '';
    }
